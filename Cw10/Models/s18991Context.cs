...
{
    public partial class s18991Context : DbContext
    {
        public s18991Context()
        {
        }

        public s18991Context(DbContextOptions<s18991Context> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<Proceduree> Proceduree { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=db-mssql;Initial Catalog=s18991;Integrated Security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Proceduree>(entity =>
            {
